...
const buttonClasses = computed(() => {
    ...
    const variantClasses = {
        ...
        secondary: 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200 focus:ring-emerald-500 disabled:bg-gray-100 disabled:text-gray-400 border border-emerald-200',
        ...
        outline: 'bg-transparent text-emerald-700 border-2 border-emerald-600 hover:bg-emerald-50 focus:ring-emerald-500 disabled:border-gray-300 disabled:text-gray-400',
