        ...
        <div class="space-y-6">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6">
                <div class="mb-4 flex items-center justify-between">
                    <h3 class="text-lg font-semibold text-gray-900">Daftar Transaksi Kredit ({{ transaksi?.total || 0 }})</h3>
                ...
                <div v-if="transaksi.last_page > 1" class="mt-6 flex flex-col items-center justify-between gap-4 border-t border-gray-100 pt-6 md:flex-row">
                    <p class="text-sm text-gray-600">
                        ...
                        <span class="font-semibold text-emerald-600">{{ transaksi.total || 0 }}</span> transaksi kredit
                    </p>
