...
// Rasio mengikuti isi_per_pack; saat mode penuh, qty_to = qty_from * rasio
watch(
    () => form.qty_from,
    () => {
        if (form.qty_from > 0 && form.rasio > 0) {
...
<template>
    <BaseLayout title="Tambah Konversi Stok - Sari Bumi Sakti" :menuItems="adminMenuItems" userRole="admin">
        <template #header> Tambah Konversi Stok </template>
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-emerald-800">Tambah Konversi Stok</h2>
                <p class="mt-1 text-sm text-gray-600">Buat aturan konversi baru antar satuan produk</p>
            </div>
            <Link
