                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="border-t border-emerald-200 pt-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                            ...
                            <!-- Batas Stok Minimum -->
                            <div>
                                <label class="mb-2 block text-sm font-medium text-emerald-700"> Batas Stok Minimum * </label>
                                <input
                                    v-model.number="form.batas_stok_minimum"
                                    type="number"
                                    min="0"
                                    class="w-full rounded-lg border border-emerald-200 bg-white-emerald px-3 py-2 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500 focus:outline-none"
                                    placeholder="Stok minimum sebelum reorder"
                                    required
                                />
                            ...
                            <!-- Jumlah Restock -->
                            <div>
                                <label class="mb-2 block text-sm font-medium text-emerald-700"> Jumlah Restock * </label>
                                <input
                                    v-model.number="form.jumlah_restock"
                                    type="number"
                                    min="0"
                                    class="w-full rounded-lg border border-emerald-200 bg-white-emerald px-3 py-2 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500 focus:outline-none"
                                    placeholder="Jumlah untuk restock"
                                    required
                                />
