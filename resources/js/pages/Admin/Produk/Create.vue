                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="mb-6 flex items-center justify-between">
                            ...
                            <Link :href="route('admin.produk.index')" class="rounded bg-gray-500 px-4 py-2 font-bold text-white hover:bg-gray-700">
                                Kembali
                            </Link>
                        </div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            :class="{ 'border-red-500': errors.id_produk }"
                                        />
                                        <div v-if="errors.id_produk" class="mt-1 text-sm text-red-500">
                                            {{ errors.id_produk }}
                                        </div>
                                    </div>
