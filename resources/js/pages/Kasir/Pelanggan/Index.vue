...
function deletePelanggan() {
    if (deleteTarget.value) {
        router.delete(`/kasir/customers/${deleteTarget.value.id_pelanggan}`, {
            onSuccess: () => {
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-emerald-600">Kelola data pelanggan</p>
                </div>
                <BaseButton @click="$inertia.visit('/kasir/customers/create')" variant="primary" icon="fas fa-plus"> Tambah Pelanggan </BaseButton>
            </div>
            ...
            <div class="card-emerald overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="border-b border-emerald-200 bg-emerald-50">
                            <tr>
                                <th class="px-6 py-3 text-left text-xs font-medium tracking-wider text-emerald-600 uppercase">ID</th>
                            ...
                            >
                                ...
                                <td class="px-6 py-4 text-right text-sm font-medium whitespace-nowrap">
                                    <div class="flex items-center justify-end gap-2">
                                        <BaseButton
                                            @click="$inertia.visit(`/kasir/customers/${item.id_pelanggan}`)"
                                            variant="secondary"
                                            icon="fas fa-eye"
                                        ...
                                        />
                                        <BaseButton
                                            @click="$inertia.visit(`/kasir/customers/${item.id_pelanggan}/edit`)"
                                            variant="secondary"
                                            icon="fas fa-edit"
                                            custom-class="rounded-lg p-2"
                                            title="Edit"
                ...
                <div v-if="pelanggan.data.length === 0" class="py-12 text-center">
                    ...
                    <BaseButton @click="$inertia.visit('/kasir/customers/create')" variant="primary" icon="fas fa-plus">
                        Tambah Pelanggan
                    </BaseButton>
                </div>
            </div>
