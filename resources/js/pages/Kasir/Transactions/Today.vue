...
const {
    ...
    closeDetailModal,
    getStatusBadgeClass,
} = useTransactionsList<Transaksi>(props, { baseUrl: '/kasir/transactions/today', withDateRange: false });

// Additional helper functions not covered by composable
...
// getStatusBadgeClass provided by composable
