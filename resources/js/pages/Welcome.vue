                ...
                >
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        ...
                        <li>
                            <Link
                                href="/login"
                                class="inline-block rounded-sm border border-black bg-transparent px-5 py-1.5 text-sm leading-normal text-black hover:border-black hover:bg-black hover:text-white dark:border-[#eeeeec] dark:bg-transparent dark:text-[#eeeeec] dark:hover:border-white dark:hover:bg-white dark:hover:text-[#1C1C1A]"
                            >
                                Login
                            </Link>
                        </li>
